...
public class LevelEditorUI : MonoBehaviour {
	...
	void Start () {
		mc = (GameObject.Find ("Master")).GetComponent("MasterController") as MasterController;
		mc.loadSettings();
	...
	private void loadSettingsFromPreferences(){
		terrainNum = PlayerPrefs.GetInt("num_of_terrains",1);
		formatInt = PlayerPrefs.GetInt("using_eqFormat",0);
		byte terrainTemp = (byte)PlayerPrefs.GetInt("using_terrains",0);
		...
		byte opTemp = (byte)PlayerPrefs.GetInt("using_operations",0);
