...
/*bool boolVar = false;//Toggle
	...
	*/
	...
	/*	toolbarInt = GUI.Toolbar(new Rect(25, 25, 250, 30), toolbarInt, toolbarStrings);
		...
		if(GUI.Button (new Rect(Screen.width/5 ,(23*intDivider) ,(3*(Screen.width/5)) ,(15*intDivider) ) ,("START GAME") ,GUI.skin.GetStyle("box") ) ){
				audio.PlayOneShot(onHoverGuiSound);
				Debug.Log("Mathius Clicked");
				Application.LoadLevel("Earth Scene");}
		if(GUI.Button (new Rect(Screen.width/5,(39*intDivider),(3*(Screen.width/5)),(15*intDivider)), ("Tutorial"),GUI.skin.GetStyle("box"))){
				audio.PlayOneShot(onHoverGuiSound);
				Debug.Log("Tutorial Clicked");
		}
				//GUI.skin.button.hover(Audio.PlayOneShot(onHoverGuiSound));
		
		if(GUI.Button (new Rect(Screen.width/5,(55*intDivider), (3*(Screen.width/5)), (15*intDivider)), ("High Score"),GUI.skin.GetStyle("box"))){
				audio.PlayOneShot(onHoverGuiSound);
				Debug.Log("HighScore Clicked");
				Application.LoadLevel("HighScores");}
		if(GUI.Button(new Rect(Screen.width/5,(72*intDivider),(3*(Screen.width/5)),(15*intDivider)),("Credits"),GUI.skin.GetStyle("box"))){
				audio.PlayOneShot(onHoverGuiSound);
				Debug.Log("Credits Clicked");
				Application.LoadLevel("Credits");}
		if(GUI.Button(new Rect(Screen.width/5,(88*intDivider), (3*(Screen.width/5)), (15*intDivider)), ("Exit"),GUI.skin.GetStyle("box"))){
				audio.PlayOneShot(onHoverGuiSound);
